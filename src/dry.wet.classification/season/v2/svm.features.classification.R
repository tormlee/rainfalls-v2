...
for(season in x.season){
  data.train.path <- sprintf("data/tuning/season/data.train.%s.v2.csv", season)
  data.test.path <- sprintf("data/tuning/season/data.test.%s.v2.csv", season)
  svm.rs.log <- sprintf("result/season/svm.%s.classification.ft.v2.log", season)
