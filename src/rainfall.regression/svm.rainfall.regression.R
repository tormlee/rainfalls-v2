...
library(caret)
cluster <- 0
data.train <- get.cluster(read.csv("data/tuning/extreme/data.train.extreme.v3_01.csv", header=TRUE), cluster)
data.test <- get.cluster(read.csv("data/tuning/extreme/data.test.extreme.v3_01.csv", header=TRUE), cluster)
svm.rs.log <- sprintf("result/extreme/svm.rainfall.regression.ft.v3_01_(cluster_%02d).log", cluster)
