...
for(i in c(1:nrow(data.train))){
  ...
  dry.month <- c("09", "10", "11", "12", "01", "02", "03", "04")
...
write.table(data.train.dry, file="data/tuning/season/data.train.dry.v2.csv", row.names=FALSE, sep=",", quote=FALSE)
write.table(data.train.rain, file="data/tuning/season/data.train.rain.v2.csv", row.names=FALSE, sep=",", quote=FALSE)
#
#
...
write.table(data.test.dry, file="data/tuning/season/data.test.dry.v2.csv", row.names=FALSE, sep=",", quote=FALSE)
write.table(data.test.rain, file="data/tuning/season/data.test.rain.v2.csv", row.names=FALSE, sep=",", quote=FALSE)
