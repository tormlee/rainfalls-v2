...
cluster.z <- rain.sc[which(rain.km$cluster == 3)]
...
#
write.table(data.train.extreme, file="data/tuning/extreme/data.train.extreme.v3.csv", row.names=FALSE, sep=",", quote=FALSE)
write.table(data.test.extreme, file="data/tuning/extreme/data.test.extreme.v3.csv", row.names=FALSE, sep=",", quote=FALSE)
